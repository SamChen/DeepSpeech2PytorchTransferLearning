...
def load_weights_hiddenlayers(model_path):
    conv0_weights   = load_parameter(os.path.join(model_path, "___conv_0__.w0"))
    conv0_weights   = conv0_weights.reshape(32, 1, 41, 11)
    conv0_weights   = np.transpose(conv0_weights, (0, 1, 3, 2))
    conv0_bn_mean   = load_parameter(os.path.join(model_path, "___batch_norm_0__.w1"))
    conv0_bn_var    = load_parameter(os.path.join(model_path, "___batch_norm_0__.w2"))
    conv0_bn_gamma  = load_parameter(os.path.join(model_path, "___batch_norm_0__.w0"))
    conv0_bn_beta   = load_parameter(os.path.join(model_path, "___batch_norm_0__.wbias"))


    conv1_weights   = load_parameter(os.path.join(model_path, "___conv_1__.w0"))
    conv1_weights   = conv1_weights.reshape(32, 32, 21, 11)
    conv1_weights   = np.transpose(conv1_weights, (0, 1, 3, 2))
    conv1_bn_mean   = load_parameter(os.path.join(model_path, "___batch_norm_1__.w1"))
    conv1_bn_var    = load_parameter(os.path.join(model_path, "___batch_norm_1__.w2"))
    conv1_bn_gamma  = load_parameter(os.path.join(model_path, "___batch_norm_1__.w0"))
    conv1_bn_beta   = load_parameter(os.path.join(model_path, "___batch_norm_1__.wbias"))

    # gru0
    bigru0_directions_0_cell_weight_i         = load_parameter(os.path.join(model_path, "___fc_layer_0__.w0"))
    bigru0_directions_0_cell_weight_i         = bigru0_directions_0_cell_weight_i.reshape(41 * 32, 1024*3)
    bigru0_directions_0_cell_weight_h         = load_parameter(os.path.join(model_path, "___gru_0__.w0"))
    ...
    bigru0_directions_0_cell_bias             = load_parameter(os.path.join(model_path, "___gru_0__.wbias"))
    bigru0_directions_0_cell_bn_bias          = load_parameter(os.path.join(model_path, "___batch_norm_2__.wbias"))
    bigru0_directions_0_cell_bn_weight        = load_parameter(os.path.join(model_path, "___batch_norm_2__.w0"))
    bigru0_directions_0_cell_bn_running_mean  = load_parameter(os.path.join(model_path, "___batch_norm_2__.w1"))
    bigru0_directions_0_cell_bn_running_var   = load_parameter(os.path.join(model_path, "___batch_norm_2__.w2"))

    bigru0_directions_1_cell_weight_i         = load_parameter(os.path.join(model_path, "___fc_layer_1__.w0"))
    bigru0_directions_1_cell_weight_i         = bigru0_directions_1_cell_weight_i.reshape(41 * 32, 1024*3)
    bigru0_directions_1_cell_weight_h         = load_parameter(os.path.join(model_path, "___gru_1__.w0"))
    ...
    bigru0_directions_1_cell_bias             = load_parameter(os.path.join(model_path, "___gru_1__.wbias"))
    bigru0_directions_1_cell_bn_bias          = load_parameter(os.path.join(model_path, "___batch_norm_3__.wbias"))
    bigru0_directions_1_cell_bn_weight        = load_parameter(os.path.join(model_path, "___batch_norm_3__.w0"))
    bigru0_directions_1_cell_bn_running_mean  = load_parameter(os.path.join(model_path, "___batch_norm_3__.w1"))
    bigru0_directions_1_cell_bn_running_var   = load_parameter(os.path.join(model_path, "___batch_norm_3__.w2"))


    # gru1
    bigru1_directions_0_cell_weight_i         = load_parameter(os.path.join(model_path, "___fc_layer_2__.w0"))
    bigru1_directions_0_cell_weight_h         = load_parameter(os.path.join(model_path, "___gru_2__.w0"))
    bigru1_directions_0_cell_bias             = load_parameter(os.path.join(model_path, "___gru_2__.wbias"))
    bigru1_directions_0_cell_bn_bias          = load_parameter(os.path.join(model_path, "___batch_norm_4__.wbias"))
    bigru1_directions_0_cell_bn_weight        = load_parameter(os.path.join(model_path, "___batch_norm_4__.w0"))
    bigru1_directions_0_cell_bn_running_mean  = load_parameter(os.path.join(model_path, "___batch_norm_4__.w1"))
    bigru1_directions_0_cell_bn_running_var   = load_parameter(os.path.join(model_path, "___batch_norm_4__.w2"))
    ...
    bigru1_directions_1_cell_weight_i         = load_parameter(os.path.join(model_path, "___fc_layer_3__.w0"))
    bigru1_directions_1_cell_weight_h         = load_parameter(os.path.join(model_path, "___gru_3__.w0"))
    bigru1_directions_1_cell_bias             = load_parameter(os.path.join(model_path, "___gru_3__.wbias"))
    bigru1_directions_1_cell_bn_bias          = load_parameter(os.path.join(model_path, "___batch_norm_5__.wbias"))
    bigru1_directions_1_cell_bn_weight        = load_parameter(os.path.join(model_path, "___batch_norm_5__.w0"))
    bigru1_directions_1_cell_bn_running_mean  = load_parameter(os.path.join(model_path, "___batch_norm_5__.w1"))
    bigru1_directions_1_cell_bn_running_var   = load_parameter(os.path.join(model_path, "___batch_norm_5__.w2"))
    ...
    # gru2
    bigru2_directions_0_cell_weight_i         = load_parameter(os.path.join(model_path, "___fc_layer_4__.w0"))
    bigru2_directions_0_cell_weight_h         = load_parameter(os.path.join(model_path, "___gru_4__.w0"))
    bigru2_directions_0_cell_bias             = load_parameter(os.path.join(model_path, "___gru_4__.wbias"))
    bigru2_directions_0_cell_bn_bias          = load_parameter(os.path.join(model_path, "___batch_norm_6__.wbias"))
    bigru2_directions_0_cell_bn_weight        = load_parameter(os.path.join(model_path, "___batch_norm_6__.w0"))
    bigru2_directions_0_cell_bn_running_mean  = load_parameter(os.path.join(model_path, "___batch_norm_6__.w1"))
    bigru2_directions_0_cell_bn_running_var   = load_parameter(os.path.join(model_path, "___batch_norm_6__.w2"))
    ...
    bigru2_directions_1_cell_weight_i         = load_parameter(os.path.join(model_path, "___fc_layer_5__.w0"))
    bigru2_directions_1_cell_weight_h         = load_parameter(os.path.join(model_path, "___gru_5__.w0"))
    bigru2_directions_1_cell_bias             = load_parameter(os.path.join(model_path, "___gru_5__.wbias"))
    bigru2_directions_1_cell_bn_bias          = load_parameter(os.path.join(model_path, "___batch_norm_7__.wbias"))
    bigru2_directions_1_cell_bn_weight        = load_parameter(os.path.join(model_path, "___batch_norm_7__.w0"))
    bigru2_directions_1_cell_bn_running_mean  = load_parameter(os.path.join(model_path, "___batch_norm_7__.w1"))
    bigru2_directions_1_cell_bn_running_var   = load_parameter(os.path.join(model_path, "___batch_norm_7__.w2"))
...
def load_weights_bottleneck(model_path):
    battleneck_weight = load_parameter(os.path.join(model_path, "___fc_layer_6__.w0"))
    battleneck_weight = battleneck_weight.reshape(2048, 29).transpose(1,0)
    battleneck_bias   = load_parameter(os.path.join(model_path, "___fc_layer_6__.wbias"))
    pretrained_weights = {
